...
public class CommandWoodCut
{
    ...
    public static void woodCut(CommandContext co)
    {
        ...
        var input = new WoodCutInput(
            co.inventory.getLevel(),
            Curser.isBlessed(co.userProperties, EnumBlessing.BETTER_WOODCUT),
            Curser.isCursed(co.userProperties, EnumCurse.WORSE_WOODCUT)
        );
        ...
        switch (result.outcome())
        {
            ...
            case DEFEATED_THE_WEREWOLF -> co.respondf("""
                :full_moon: You hear howling as you are approaching a small hill.
                You feel extraordinaly strong today and approach the werewolf.
                *%s With a well-aimed swing, you kill it and notice it has been carrying a treasure (**%s**).*""",
                Icons.SCROLL_UNIQUE, drops.toStringJoined(", "));

            case BROKE_AXE -> co.respond("You break your axe and go home empty-handed.");
